  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col w-[90vw] py-10">
        ...
        <div className=" px-8 py-16 mb-4 w-[80vw] flex items-center justify-center space-x-32">
          <div className="w-1/3">
            <p className="leading-relaxed text-xl mb-4 text-white font-semibold">
              {movie.overview}
            </p>
            <button
              className="relative inline-flex w-full items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl text-black font-medium  rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-black focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800"
