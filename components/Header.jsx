  ...
  return (
    <>
      <header className="text-gray-300 body-font bg-gray-600">
        <div className="mx-auto flex space-y-3 py-5 px-10 flex-col md:flex-row items-center">
          <Link
            href="/"
            onClick={handleClick}
          ...
          <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base text-center justify-center cursor-pointer">
